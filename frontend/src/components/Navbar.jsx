...
import { setToken } from '/src/store/slice/authSlice';
...
const Navbar = () => {
  ...
  return (
    <div className='fixed top-0 left-0 right-0 bg-white z-50 flex items-center justify-between text-sm py-4 shadow-md'>
